...
class  UpdateRequestvalidate extends Command
{
     /**
     ...
     * @var string
     */
    protected $signature = 'update:Request-validate {name}';
    ...
    public function handle()
    {
        ...
        $routeFilePath = base_path('app/Http/Requests/Admin/'. $name . '/' . 'UpdateRequest.php');
        $content = <<<EOT
        <?php
